...
JNIEXPORT jint JNICALL Java_com_zhanghui_FFmpegAndroidCameraEncoder_MainActivity_initial
...
JNIEXPORT jint JNICALL Java_com_zhanghui_FFmpegAndroidCameraEncoder_MainActivity_encode
...
JNIEXPORT jint JNICALL Java_com_zhanghui_FFmpegAndroidCameraEncoder_MainActivity_close
  (JNIEnv *env, jobject obj)
{
	if (video_st)
